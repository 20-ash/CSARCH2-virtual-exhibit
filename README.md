...
<mark>
| <mark>Type of AI used | Purpose of using the AI | Description of AI contribution <br>*(Detail the extent to which AI contributed to the assignment, including specific sections or tasks where AI was used)* | Member’s contribution <br>*(Describe your own input and how you integrated AI-generated content into your work)*</mark> |
| :--- | :--- | :--- | :--- |
